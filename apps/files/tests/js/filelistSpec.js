		...
		describe('Actions', function() {
			...
			describe('Download', function() {
				it('Opens download URL when clicking "Download"', function() {
					...
					expect(redirectStub.getCall(0).args[0]).toContain(OC.webroot + '/index.php/apps/files/ajax/download.php?dir=%2Fsubdir&files[]=One.txt&files[]=Three.pdf&files[]=somedir');
					redirectStub.restore();
				});
				it('Downloads root folder when all selected in root folder', function() {
					...
					$('.selectedActions .download').click();
					expect(redirectStub.calledOnce).toEqual(true);
					expect(redirectStub.getCall(0).args[0]).toContain(OC.webroot + '/index.php/apps/files/ajax/download.php?dir=%2F');
				});
